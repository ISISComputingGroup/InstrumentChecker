...
class GlobalsTests(unittest.TestCase):
    ...
    def test_GIVEN_a_definition_where_there_is_more_than_one_double_underscore_WHEN_syntax_check_THEN_invalid(
        self,
    ):
        # Arrange
    ...
    def test_GIVEN_a_definition_where_there_are_lots_of_single_underscores_WHEN_syntax_check_THEN_valid(
        self,
    ):
        # Arrange
    ...
    def test_GIVEN_a_macro_value_looks_like_a_valid_macro_definition_WHEN_syntax_check_THEN_valid(
        self,
    ):
        # Arrange
    ...
    def test_GIVEN_macro_definition_is_invalid_but_value_contains_valid_definition_WHEN_syntax_check_THEN_invalid(
        self,
    ):
        # Arrange
    ...
    def test_GIVEN_an_invalid_macro_definition_that_is_commented_out_WHEN_syntax_check_THEN_valid(
        self,
    ):
        # Arrange
    ...
    def test_GIVEN_a_line_WHEN_macro_requested_for_correct_ioc_name_THEN_key_and_value_matches_input(
        self,
    ):
        # Arrange
        ioc_name = "MYIOC_01"
    ...
    def test_GIVEN_a_line_WHEN_value_requested_for_correct_macro_name_THEN_key_and_value_matches_input(
        self,
    ):
        # Arrange
        ioc_name = "MYIOC_01"
    ...
    def test_GIVEN_a_line_WHEN_value_requested_for_incorrect_macro_name_THEN_no_values_returned(
        self,
    ):
        # Arrange
        ioc_name = "MYIOC_01"
